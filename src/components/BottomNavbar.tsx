  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-gray-950 text-white shadow-lg z-50">
      <div className="flex justify-around items-center h-16 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Link Peminjaman */}
        <Link href="/peminjaman" className={`flex flex-1 flex-col items-center p-2 text-xs lg:text-sm font-medium ${isActive('/peminjaman') ? 'text-blue-200' : 'text-white hover:text-blue-100'} transition-colors duration-200`}>
        ...
        <Link href="/data-barang" className={`flex flex-1 flex-col items-center p-2 text-xs lg:text-sm font-medium ${isActive('/data-barang') ? 'text-blue-200' : 'text-white hover:text-blue-100'} transition-colors duration-200`}>
        ...
        <Link href="/data-peminjam" className={`flex flex-1 flex-col items-center p-2 text-xs lg:text-sm font-medium ${isActive('/data-peminjam') ? 'text-blue-200' : 'text-white hover:text-blue-100'} transition-colors duration-200`}>

  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-gray-950 text-white shadow-lg z-50">
      <div className="flex justify-around items-center h-16 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Link Peminjaman */}
        <Link href="/peminjaman" className={`flex flex-col items-center p-2 text-sm font-medium ${isActive('/peminjaman') ? 'text-blue-200' : 'text-white hover:text-blue-100'} transition-colors duration-200`}>
            <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7v4a4 4 0 004 4h.01M12 10V4m0 0l-3 3m3-3l3 3m-4 8v4M9 20h6a2 2 0 002-2V6a2 2 0 00-2-2H9a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
            Peminjaman
        </Link>

        {/* Link Barang (Asumsi rute '/data-barang') */}
        <Link href="/data-barang" className={`flex flex-col items-center p-2 text-sm font-medium ${isActive('/data-barang') ? 'text-blue-200' : 'text-white hover:text-blue-100'} transition-colors duration-200`}>
        ...
        {/* Link User (Asumsi rute '/data-peminjam') */}
        <Link href="/data-peminjam" className={`flex flex-col items-center p-2 text-sm font-medium ${isActive('/data-peminjam') ? 'text-blue-200' : 'text-white hover:text-blue-100'} transition-colors duration-200`}>
        ...
        {/* Link Logout */}
        <Link href="/" className={`flex flex-col items-center p-2 text-sm font-medium ${isActive('/') ? 'text-blue-200' : 'text-white hover:text-blue-100'} transition-colors duration-200`}>
